...
@.str1 = private unnamed_addr constant [12 x i8] c"Count = %d\0A\00", align 1
...
; Function Attrs: uwtable
define void @_Z6samplev() #0 {
entry:
  %0 = load i32* @count, align 4
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1, i32 0, i32 0), i32 %0)
